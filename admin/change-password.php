...
if(isset($_POST['password']))
{
    ...
    $sql=pg_query($con,"SELECT * FROM admin WHERE aid='$uno' AND apass='$p'");
    $row = pg_fetch_array($sql);
    if($row!= null)
    {
      if((strcmp($p1,$p2))==0)
      {
        $sql=pg_query($con,"update admin set apass='$p2' where aid='$uno'");
...
<html lang="en">
  <head>
    ...
    <title>Wemedia Admin | Password</title>
    <!-- Bootstrap core CSS -->
