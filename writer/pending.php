      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a href="#"><b>Welcome, <?php echo $_SESSION['login'];?></b></a></li>
        ...
        <div class="row">
          <div class="col-md-4 col-md-offset-4">
            <form id="login" action="#" class="well" method="POST">
              <center>
                <span class="glyphicon glyphicon-time" style="font-size: 50px" aria-hidden="true"></span>
              </center>
              
              <center><b>Your Account is Under Review! </b></center>     
            </form>
          </div>
        </div>
      </div>
