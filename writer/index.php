...
if(isset($_POST['username']))
{
    ...
    // Fetch data from database on the basis of username/email and password
		$sql=pg_query($con,"SELECT * FROM writer WHERE wemail='$uname' AND wpass='$password'");
		$row = pg_fetch_array($sql);
		if($row!= null)
		{
			if($row[wstatus]=='pending')
			{
				$_SESSION['login']=$row[1];
				header('location:pending.php');
			}
			else if($row[wstatus]=='suspended')
			{
...
<html lang="en">
  <head>
    ...
    <title>Writer Area | Account Login</title>
    <!-- Bootstrap core CSS -->
  ...
  <body>
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1 class="text-center"> Writer Area <small>Account Login</small></h1>
          </div>
        </div>
      </div>
    </header>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-md-offset-4">
            ...
            <form id="signup" action="signup.php" class="well">
                <div class="form-group">
